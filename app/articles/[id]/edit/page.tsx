  ...
  return (
    <div className="flex min-h-screen w-full" style={{ background: "var(--bg-primary)" }}>
      ...
      <main className="flex-1 lg:ml-[260px] pb-20 lg:pb-0">
        ...
        >
          <div>
            <h1 className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>Edit Article</h1>
        ...
        <div className="px-6 lg:px-8 py-6 max-w-7xl">
          {loading ? (
            ...
            >
              ...
              <p className="text-sm" style={{ color: "var(--text-muted)" }}>The article may have been deleted.</p>
            </div>
          ) : (
