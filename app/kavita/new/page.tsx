  ...
  return (
    <div className="flex min-h-screen w-full" style={{ background: "var(--bg-primary)" }}>
      ...
      <main className="flex-1 lg:ml-[260px] pb-20 lg:pb-0">
        ...
        >
          <div>
            <h1 className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>Create New Kavita</h1>
            <p className="text-xs" style={{ color: "var(--text-muted)" }}>
              Write and publish a new kavita (poem)
            </p>
          </div>
        </header>

        <div className="px-6 lg:px-8 py-6 max-w-7xl">
            <NewsForm mode="create" apiEndpoint="/api/kavita" redirectPath="/kavita" />
        </div>
      </main>
    </div>
  );
